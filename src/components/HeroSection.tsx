          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                Achieve your{' '}
                <span className="text-secondary-300">Medical Career Goals</span>{' '}
                with FutureNex
              </h1>
              <p className="text-xl md:text-2xl text-sage-100 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                to="/services"
                className="inline-flex items-center justify-center border-2 border-white text-white font-bold py-4 px-8 rounded-lg hover:bg-white hover:text-sage-700 transition-all duration-300"
              >
                Learn More
              </Link>
            </div>
            ...
            {/* Trust Indicators */}
            <div className="flex flex-wrap items-center gap-8 pt-8 border-t border-sage-400/30">
              <div className="text-center">
                <div className="text-2xl font-bold">95%</div>
                <div className="text-sm text-sage-200">Success Rate</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold">500+</div>
                <div className="text-sm text-sage-200">Students Placed</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold">10+</div>
                <div className="text-sm text-sage-200">Years Experience</div>
              </div>
            </div>
          </div>
